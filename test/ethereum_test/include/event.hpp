...
{
    RingEvent<kinet_exec_block_start> block_start;
    RingEvent<kinet_exec_block_end> block_end;
    RingEvent<kinet_exec_block_reject> block_reject_code;
    RingEvent<kinet_exec_txn_reject> txn_reject_code;
    std::vector<RingEvent<kinet_exec_txn_header_start>> txn_inputs;
    std::vector<RingEvent<kinet_exec_txn_evm_output>> txn_evm_outputs;
};
...
void find_execution_events(
    kinet_event_ring const *, kinet_event_iterator *, ExecutionEvents *);
