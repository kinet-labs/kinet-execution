...
std::initializer_list<
    quick_status_code_from_enum<kinet::AbiDecodeError>::mapping> const &
quick_status_code_from_enum<kinet::AbiDecodeError>::value_mappings()
{
    using kinet::AbiDecodeError;
