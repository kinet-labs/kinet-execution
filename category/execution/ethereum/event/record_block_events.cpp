...
void record_block_start(
    ...
    std::optional<kinet_c_secp256k1_pubkey> const &opt_block_author,
    std::optional<kinet_c_native_block_input> const &opt_kinet_input)
{
    ...
    *block_start.payload = kinet_exec_block_start{
        .block_tag{
            .id = bft_block_id,
    ...
    if (result.has_error()) {
        ...
        if (error_domain == block_err_domain) {
            ReservedEvent const block_reject =
                exec_recorder->reserve_block_event<kinet_exec_block_reject>(
            ...
            *block_reject.payload = static_cast<uint32_t>(error_value);
            ...
            ReservedEvent const evm_error =
                exec_recorder->reserve_block_event<kinet_exec_evm_error>(
        ...
        ReservedEvent const block_end =
            exec_recorder->reserve_block_event<kinet_exec_block_end>(
                KINET_EXEC_BLOCK_END);
        BlockExecOutput const &exec_output = result.value();
        *block_end.payload = kinet_exec_block_end{
            ...
            .exec_output = {
                ...
                .logs_bloom = std::bit_cast<kinet_c_bloom256>(
