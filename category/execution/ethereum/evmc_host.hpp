...
struct EvmcHost final : public EvmcHostBase
{
    ...
    virtual evmc::Result call(evmc_message const &msg) noexcept override
    {
        KINET_TRY
        {
            if (msg.kind == EVMC_CREATE || msg.kind == EVMC_CREATE2) {
                auto result =
                    ::kinet::execute_create_message<traits>(this, state_, msg);
                ...
                return ::kinet::execute_call_message<traits>(this, state_, msg);
            }
        }
        KINET_CATCH(...)
        {
        ...
        evmc_storage_status const status) noexcept override
    {
        if constexpr (traits::mip_8_active()) {
            ...
            KINET_ABORT("update_page is MIP-8 only");
        }
    }
...
static_assert(
    sizeof(EvmcHost<EvmTraits<KINET_ETH_LATEST_STABLE_REVISION>>) == 136);
static_assert(
    alignof(EvmcHost<EvmTraits<KINET_ETH_LATEST_STABLE_REVISION>>) == 8);
static_assert(sizeof(EvmcHost<KinetTraits<KINET_NEXT>>) == 136);
static_assert(alignof(EvmcHost<KinetTraits<KINET_NEXT>>) == 8);
