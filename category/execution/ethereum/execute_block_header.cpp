...
#include <category/execution/kinet/staking/execute_block_prelude.hpp>
    ...
    ExecutionEventRecorder *exec_recorder)
{
    ...
    // TODO: move to execute_kinet_block eventually
    ...
    record_account_access_events(
        exec_recorder, KINET_ACCT_ACCESS_BLOCK_PROLOGUE, state);
}
