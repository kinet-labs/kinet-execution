...
std::initializer_list<
    quick_status_code_from_enum<kinet::TransactionError>::mapping> const &
quick_status_code_from_enum<kinet::TransactionError>::value_mappings()
{
    using kinet::TransactionError;
