...
TYPED_TEST(DBTest, commit_receipts_transactions)
{
    ...
    std::vector<kinet_hash256> tx_hash;
    ...
    auto verify_tx_hash = [&](kinet_hash256 const &tx_hash,
