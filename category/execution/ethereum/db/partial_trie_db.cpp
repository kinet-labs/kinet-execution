    ...
    return match(
        ...
        Cases{
            ...
            [](auto) -> std::optional<Account> {
                KINET_ABORT("incorrect node type returned in read_account");
            }});
}
    ...
    Address const &addr, Incarnation, bytes32_t const &slot)
{
    ...
    auto const sroot = match(
        ...
        Cases{
            ...
            [](auto) -> mpt::NodeId {
                KINET_ABORT("incorrect node type returned in read_storage");
            }});
    ...
    std::function<void(BlockHeader &)> populate_header_fn)
{
    ...
    for (auto const &[addr, delta] : deltas) {
        ...
        if (KINET_UNLIKELY(trie_.root == NULL_ID)) {
        ...
        NodeId storage = match(
            ...
            Cases{
                ...
                [](auto) -> NodeId {
                    KINET_ABORT("incorrect node type returned in commit");
                }});
