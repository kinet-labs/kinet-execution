...
#include <category/execution/kinet/staking/fuzzer/staking_contract_model.hpp>
...
namespace kinet::staking::test
{
    ...
    EXPLICIT_KINET_TRAITS_MEMBER(StakingContractModel::syscall_reward)
    ...
    EXPLICIT_KINET_TRAITS_MEMBER(StakingContractModel::precompile_add_validator)
    ...
    EXPLICIT_KINET_TRAITS_MEMBER(StakingContractModel::precompile_delegate)
    ...
    EXPLICIT_KINET_TRAITS_MEMBER(StakingContractModel::precompile_undelegate)
    ...
    EXPLICIT_KINET_TRAITS_MEMBER(StakingContractModel::precompile_compound)
    ...
    EXPLICIT_KINET_TRAITS_MEMBER(StakingContractModel::precompile_withdraw)
    ...
    EXPLICIT_KINET_TRAITS_MEMBER(StakingContractModel::precompile_claim_rewards)
    ...
    EXPLICIT_KINET_TRAITS_MEMBER(StakingContractModel::precompile_get_delegator)
        ...
        u64_be const val_id, u256_be const &reward_be)
    {
        ...
        KINET_ASSERT(computed_total_stake == active_consensus_stake_[v]);
    }
    ...
    EXPLICIT_KINET_TRAITS_MEMBER(StakingContractModel::dispatch)
}
