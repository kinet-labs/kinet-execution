...
std::initializer_list<
    quick_status_code_from_enum<kinet::staking::StakingError>::mapping> const &
quick_status_code_from_enum<kinet::staking::StakingError>::value_mappings()
{
    using kinet::staking::StakingError;
