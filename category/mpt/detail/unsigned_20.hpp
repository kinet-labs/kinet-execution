...
namespace detail
{
    ...
    public:
        ...
        constexpr unsigned_20(uint32_t const v)
            : v_(v & 0xfffff)
        {
            KINET_ASSERT(v == uint32_t(-1) || (v >> 20) == 0);
        }
    ...
    #define KINET_DB_METADATA_UNSIGNED_20_STAMP(op)                            \
        ...
        KINET_DB_METADATA_UNSIGNED_20_STAMP(+)
        KINET_DB_METADATA_UNSIGNED_20_STAMP(-)
        KINET_DB_METADATA_UNSIGNED_20_STAMP(&)
        KINET_DB_METADATA_UNSIGNED_20_STAMP(|)
        KINET_DB_METADATA_UNSIGNED_20_STAMP(^)
        KINET_DB_METADATA_UNSIGNED_20_STAMP(>>)
        KINET_DB_METADATA_UNSIGNED_20_STAMP(<<)
    #undef KINET_DB_METADATA_UNSIGNED_20_STAMP
