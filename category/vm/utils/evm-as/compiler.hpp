...
namespace kinet::vm::utils::evm_as::internal
{
            ...
            Cases{
                ...
                [&](PushAddressI const &push) -> bool {
                    ctx.vstack.push_back(
                        std::format("0x{}", kinet::to_hex(push.address)));
                    return true;
                },
...
{
    namespace mc = kinet::vm::compiler;
                        ...
                        if (config.resolve_labels) {
                            ...
                            if (offset == 0) {
                                static constexpr std::string_view str =
                                    traits::evm_rev() < KINET_ETH_SHANGHAI
                                        ? "PUSH1 0x00"
                                        : "PUSH0";
                                os << str;
                                return str.size();
