...
#include <memory>
        ...
        #define KINET_VM_MUST_TAIL __attribute__((musttail))
    #else
...
#define KINET_VM_NEXT(OP)                                                      \
    do {                                                                       \
        ...
        KINET_VM_MUST_TAIL return instruction_table<traits>[*instr_ptr](       \
            ctx,                                                               \
            analysis,                                                          \
            stack_bottom,                                                      \
            stack_top + delta,                                                 \
...
namespace kinet::vm::interpreter
{
    ...
    {
        static_assert(traits::evm_rev() >= KINET_ETH_ISTANBUL);
        ...
        uint256_t const *stack_top, uint64_t const base_offset)
    {
        ...
        kinet::vm::runtime::debug_tstore_stack(
            &ctx,
            stack_top + 1,
    ...
    // Arithmetic
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void udiv(
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void sdiv(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void umod(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void smod(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void addmod(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(ADDMOD);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void mulmod(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void signextend(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void iszero(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(ISZERO);
    }

    // Bitwise
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void and_(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void xor_(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void not_(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void byte(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    // Data
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void sha3(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void address(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(ADDRESS);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void balance(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(BALANCE);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void origin(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(ORIGIN);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void caller(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(CALLER);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void callvalue(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(CALLVALUE);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void calldataload(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(CALLDATALOAD);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void calldatasize(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(CALLDATASIZE);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void calldatacopy(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(CALLDATACOPY);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void codesize(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(CODESIZE);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void codecopy(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(CODECOPY);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void gasprice(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(GASPRICE);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void extcodesize(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(EXTCODESIZE);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void extcodecopy(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(EXTCODECOPY);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void returndatasize(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(RETURNDATASIZE);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void returndatacopy(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(RETURNDATACOPY);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void extcodehash(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(EXTCODEHASH);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void blockhash(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(BLOCKHASH);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void coinbase(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(COINBASE);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void timestamp(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(TIMESTAMP);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void number(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(NUMBER);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void prevrandao(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(DIFFICULTY);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void gaslimit(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(GASLIMIT);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void chainid(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(CHAINID);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void selfbalance(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(SELFBALANCE);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void basefee(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(BASEFEE);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void blobhash(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(BLOBHASH);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void blobbasefee(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(BLOBBASEFEE);
    }

    // Memory & Storage
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void mload(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void mstore(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(MSTORE);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void mstore8(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(MSTORE8);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void mcopy(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void sstore(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(SSTORE);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void sload(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void tstore(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(TSTORE);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void tload(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void msize(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <size_t N, Traits traits>
        requires(N <= 32)
    KINET_VM_INSTRUCTION_CALL void push(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(DUP1 + (N - 1));
    }

    template <size_t N, Traits traits>
        requires(N >= 1)
    KINET_VM_INSTRUCTION_CALL void swap(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    namespace
    {
        ...
        {
            if (KINET_UNLIKELY(target > std::numeric_limits<size_t>::max())) {
                ctx.exit(Error);
            }

            auto const jd = static_cast<size_t>(target);
            if (KINET_UNLIKELY(!analysis.is_jumpdest(jd))) {
                ctx.exit(Error);
            }
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void jump(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *)
    {
        ...
        KINET_VM_MUST_TAIL return instruction_table<traits>[*new_ip](
            ctx, analysis, stack_bottom, stack_top, gas_remaining, new_ip);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void jumpi(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void jumpdest(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(LOG0 + N);
    }

    // Call & Create
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void create(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(CREATE);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void call(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void callcode(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(CALLCODE);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void delegatecall(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(DELEGATECALL);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void create2(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
        ...
        KINET_VM_NEXT(CREATE2);
    }

    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void staticcall(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void return_(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void revert(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *)
    {
    ...
    template <Traits traits>
    KINET_VM_INSTRUCTION_CALL void selfdestruct(
        runtime::Context &ctx, Intercode const &analysis,
        uint256_t const *stack_bottom, uint256_t *stack_top,
        int64_t gas_remaining, uint8_t const *instr_ptr)
    {
    ...
    KINET_VM_INSTRUCTION_CALL inline void stop(
        runtime::Context &ctx, Intercode const &analysis,
    ...
    KINET_VM_INSTRUCTION_CALL inline void invalid(
...
#undef KINET_VM_MUST_TAIL
#undef KINET_VM_NEXT
#undef KINET_VM_NEXT_PUSH
