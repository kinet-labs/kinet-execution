 ...
 */
        ...
        #define KINET_VM_INSTRUCTION_CALL __attribute__((preserve_none))
    #else
        #define KINET_VM_INSTRUCTION_CALL
    #endif
#else
    #define KINET_VM_INSTRUCTION_CALL
#endif
 ...
 */
            ...
            #undef KINET_VM_INSTRUCTION_CALL
            #define KINET_VM_INSTRUCTION_CALL
        #endif
    #endif
#endif
...
{
    using InstrEval = void KINET_VM_INSTRUCTION_CALL (*)(
