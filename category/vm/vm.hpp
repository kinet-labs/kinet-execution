...
namespace kinet::vm
{
    ...
    struct VmStats
    {
        ...
        {
            if constexpr (utils::collect_kinet_compiler_hot_path_stats) {
    ...
    public:
        ...
        using ExecuteOverride = std::function<evmc::Result(
            ...
            kinet_eth_revision rev, evmc_message const *msg,
    ...
    private:
        ...
        // Execute override functionality for testing purposes:
    ...
    public:
        ...
        void debug_set_execute_override(ExecuteOverride);
