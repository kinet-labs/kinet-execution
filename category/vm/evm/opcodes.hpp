...
namespace kinet::vm::compiler
{
    ...
    {
        KINET_DEBUG_ASSERT(is_dup_opcode(opcode));
    ...
    {
        KINET_DEBUG_ASSERT(is_swap_opcode(opcode));
    ...
    {
        KINET_DEBUG_ASSERT(is_push_opcode(opcode));
        return opcode - PUSH0;
    }
    ...
    {
        KINET_DEBUG_ASSERT(is_log_opcode(opcode));
        return opcode - LOG0;
    }
