...
std::initializer_list<
    quick_status_code_from_enum<kinet::rlp::DecodeError>::mapping> const &
quick_status_code_from_enum<kinet::rlp::DecodeError>::value_mappings()
{
    using kinet::rlp::DecodeError;
