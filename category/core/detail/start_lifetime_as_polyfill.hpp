...
#ifndef KINET_USE_STD_START_LIFETIME_AS
    #if __cpp_lib_start_lifetime_as >= 202207L
        #define KINET_USE_STD_START_LIFETIME_AS 1
    #else
        #define KINET_USE_STD_START_LIFETIME_AS 0
    #endif
#endif

#if KINET_USE_STD_START_LIFETIME_AS
    #include <memory>
#endif
