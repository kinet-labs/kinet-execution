...
/// Value to pass for the `mode` parameter in kinet_path_open_subdir if it
/// is not allowed to create subdirectories
constexpr mode_t KINET_PATH_NO_CREATE = (mode_t)0;
...
int kinet_path_append(char **dst, char const *src, size_t *size);
