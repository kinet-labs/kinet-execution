...
namespace cli
{
    // CLI11 Formatter that emits clap-style --help output so the Kinet
    // execution binaries (kinet, kinet-cli, kinet-mpt) match the help layout
    // produced by the Rust binaries that go through kinet-ctl.
