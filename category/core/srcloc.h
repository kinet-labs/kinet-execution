...
typedef struct kinet_source_location kinet_source_location_t;

/// A C structure similar to C++20's std::source_location
struct kinet_source_location
{
...
#define KINET_SOURCE_LOCATION_CURRENT()                                        \
    ((kinet_source_location_t){__FUNCTION__, __FILE__, __LINE__, 0})
