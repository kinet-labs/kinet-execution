...
public:
    ...
    struct creation_flags
    {
        ...
        //! only kinet-mpt --upgrade sets this to true. When false, a
        //! DbMetadataContext ctor that observes PREVIOUS_MAGIC aborts with a
        //! message directing the operator to run kinet-mpt --upgrade.
        ...
        {
            KINET_ASSERT(bits <= MAX_CHUNK_CAPACITY_BITS);
...
public:
    ...
    //! pool should be migrated or rejected with a "run kinet-mpt --upgrade"
    //! message.
