...
struct AsyncIO : public kinet::test::AsyncTestFixture<::testing::Test>
{
};
...
struct read_single_buffer_operation_states_base_
{
    virtual bool reinitiate(
        KINET_ASYNC_NAMESPACE::erased_connected_operation *i,
        KINET_ASYNC_NAMESPACE::read_single_buffer_sender::buffer_type
            buffer) = 0;
};

template <KINET_ASYNC_NAMESPACE::receiver Receiver>
    ...
    : public read_single_buffer_operation_states_base_
{
    using io_state_type_ =
        KINET_ASYNC_NAMESPACE::AsyncIO::connected_operation_unique_ptr_type<
            KINET_ASYNC_NAMESPACE::read_single_buffer_sender, Receiver>;
...
public:
    ...
    virtual bool reinitiate(
        KINET_ASYNC_NAMESPACE::erased_connected_operation *const i,
        KINET_ASYNC_NAMESPACE::read_single_buffer_sender::buffer_type const
...
TEST_F(AsyncIO, read_multiple_buffer_sender_receiver)
{
    ...
    auto const unbuffer =
        kinet::make_scope_exit([&]() noexcept { free(buffer); });
...
struct completion_handler_io_receiver
{
    ...
    void set_value(
        ...
        KINET_ASYNC_NAMESPACE::read_single_buffer_sender::result_type const
            buffer)
    {
        ASSERT_TRUE(buffer);
...
struct cpp_suspend_resume_io_receiver
{
    ...
    using result_type = std::pair<
        ...
        KINET_ASYNC_NAMESPACE::read_single_buffer_sender::result_type>;
