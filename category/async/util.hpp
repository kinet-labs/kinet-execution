...
namespace detail
{
    ...
    //! can exercise it repeatedly under different KINET_TMPDIR_FORCE settings
...
//! (unless overridden; see `KINET_TMPDIR_FORCE` below).
//!
//! Set the `KINET_TMPDIR_FORCE` environment variable to override the search
