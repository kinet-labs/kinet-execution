...
use super::{MessageError, KinetExecutor, ETH_CALL_SUCCESS};
use crate::{ffi, ChainId, KinetExecutorResult, KinetTracer};
...
/// # Safety
/// This should be used only as a callback for kinet_executor_run_transactions
///
...
impl KinetExecutor {
    ...
    pub async fn eth_trace_block_or_transaction(
        ...
        unsafe {
            ffi::kinet_executor_run_transactions(
