...
use crate::{
    ffi::{
        g_kinet_event_content_type_names, kinet_event_content_type, kinet_event_ring,
        kinet_event_ring_check_content_type, KINET_EVENT_CONTENT_TYPE_COUNT,
        KINET_EVENT_CONTENT_TYPE_NONE,
    },
    EventDescriptorInfo,
};
...
pub trait EventDecoder: 'static {
    ...
    fn ring_ctype_name() -> String {
        ...
        assert!(KINET_EVENT_CONTENT_TYPE_NONE < content_ctype);
        assert!(content_ctype < KINET_EVENT_CONTENT_TYPE_COUNT);

        let description_cstr =
            unsafe { CStr::from_ptr(g_kinet_event_content_type_names[content_ctype as usize]) };
    ...
    fn check_ring_content_type(c_event_ring: &kinet_event_ring) -> Result<(), String> {
        kinet_event_ring_check_content_type(
            c_event_ring,
...
impl EventDecoder for BytesDecoder {
    ...
    fn check_ring_content_type(_: &kinet_event_ring) -> Result<(), String> {
        Ok(())
    }
