...
/// Represents the different block commit states from KinetBFT.
///
/// See
/// [block states](<https://docs.kinet.xyz/kinet-arch/consensus/asynchronous-execution#block-states>)
/// for more details.
...
pub struct CommitStateBlockUpdate {
    /// The block whose commit state changed.
...
pub struct CommitStateBlockBuilder {
    state: HashMap<kinet_c_bytes32, (Arc<ExecutedBlock>, BlockCommitState)>,
    proposals: BTreeMap<u64, HashSet<kinet_c_bytes32>>,
