...
use crate::ffi::{
    ...
    kinet_c_uint256_ne, kinet_exec_block_end, kinet_exec_block_start, kinet_exec_txn_call_frame,
};
...
pub struct ExecutedTxnLog {
    pub address: kinet_c_address,
    pub topic: Box<[kinet_c_bytes32]>,
    pub data: Box<[u8]>,
}
...
pub struct ExecutedTxnCallFrame {
    pub call_frame: kinet_exec_txn_call_frame,
    pub input: Box<[u8]>,
    pub r#return: Box<[u8]>,
}
...
pub struct ExecutedTxnAccessListEntry {
    pub address: kinet_c_address,
    pub storage_keys: Box<[kinet_c_bytes32]>,
}
...
pub struct ExecutedTxnSignedAuthorization {
    pub chain_id: kinet_c_uint256_ne,
    pub address: kinet_c_address,
    pub nonce: u64,

    pub y_parity: bool,
    pub r: kinet_c_uint256_ne,
    pub s: kinet_c_uint256_ne,
}
