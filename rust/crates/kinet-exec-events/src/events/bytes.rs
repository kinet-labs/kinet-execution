...
/// [`ExecEventRef::TxnHeaderStart`](crate::ExecEventRef), whose size can only be determined after
/// first parsing the event,
/// [`kinet_exec_txn_header_start`](crate::ffi::kinet_exec_txn_header_start). This function takes a
/// fn which, given this `&T` reference, produces an array of trailing byte sizes which are
/// subsequently split out and produced alongside the `&T`.
