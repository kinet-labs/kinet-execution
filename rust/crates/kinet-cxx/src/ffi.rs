...
pub(crate) use self::bindings::{
    kinet_log, kinet_log_flush_callback, kinet_log_get_last_error, kinet_log_handler,
    kinet_log_handler_create, kinet_log_handler_destroy, kinet_log_init, kinet_log_write_callback,
};
...
pub(crate) unsafe extern "C" fn log_callback(plog: *const kinet_log, _: usize) {
    if plog.is_null() {
