...
function(kinet_compile_options target)
  ...
  if(KINET_COMPILER_TESTING)
    target_compile_definitions(${target} PUBLIC "KINET_COMPILER_TESTING=1")
    target_compile_definitions(${target} PUBLIC "KINET_CORE_FORCE_DEBUG_ASSERT=1")
  endif()

  if(KINET_COMPILER_BENCHMARKS)
      target_compile_definitions(${target} PUBLIC "KINET_COMPILER_BENCHMARKS=1")
  endif()

  if(KINET_COMPILER_STATS)
      target_compile_definitions(${target} PUBLIC "KINET_COMPILER_STATS=1")
  endif()

  if(KINET_COMPILER_HOT_PATH_STATS)
      target_compile_definitions(${target} PUBLIC "KINET_COMPILER_HOT_PATH_STATS=1")
  endif()
