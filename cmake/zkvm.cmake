...
# kinet_compile_options applied.
function(kinet_zkvm_compile_options target)
    ...
    target_include_directories(${target} PUBLIC "${KINET_ROOT}")
    ...
    target_compile_definitions(${target} PUBLIC
        ...
        "KINET_ZKVM_${_ZKVM_BACKEND_UPPER}")
endfunction()
...
function(kinet_zkvm_drop_sources target)
