...
class NibblesViewPrettyPrinter(gdb.ValuePrinter):
    ...
    def __init__(self, val):
        ...
        if val.type.tag == 'kinet::mpt::Nibbles':
...
def build_pretty_printer():
    pp = gdb.printing.RegexpCollectionPrettyPrinter("kinet")
    pp.add_printer('NibblesView', 'kinet::mpt::NibblesView$', NibblesViewPrettyPrinter)
    pp.add_printer('NibblesView', 'kinet::mpt::Nibbles$', NibblesViewPrettyPrinter)
    return pp
